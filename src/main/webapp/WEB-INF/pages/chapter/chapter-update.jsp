...
<div class="pd-20">
  ...
  <form action="updateChapter" method="post" class="form form-horizontal" id="form-member-add">
  	<input type="hidden" name="cuorseId" id="cuorseId" value="${chapter.cuorseId }" >
  	<input type="hidden" name="chapterId" value="${chapter.chapterId }">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>章节名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="${chapter.chapterName }" id="chapterName" name="chapterName" datatype="*2-16" nullmsg="章节名不能为空">
      </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="${course.courseName }" readonly= id="courseName" name="courseName" >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>修改人：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="请输入你的用户名" id="member-name" name="modifyBy" datatype="*2-16" nullmsg="修改人2~16位">
      </div>
      <div class="col-4"> </div>
    </div>
