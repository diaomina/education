...
<body>
	...
	考试成绩 <!-- <a class="btn btn-success radius r mr-20"
		...
		<div class="text-c">
			...
			<%-- <form action="${webpath}/paperAnswer/toPaperAnswer2" method="post">
				...
				<input type="text" class="input-text" style="width: 100px"
					placeholder="学生学号" id="" name="stuId"> <input type="text"
					class="input-text" style="width: 100px" placeholder="试卷编号" id=""
					name="paperId">
				<!-- <input type="text" class="input-text" style="width: 100px"
 ...
 --%>
	...
	<div><h2>您的成绩： <span> ${paperScore}</span></h2> </div>
		<div class="mt-20">
			<table
				...
				<c:forEach items="${paperAnswerss}" var="paperAnswerQuestionStudentAreaVo" varStatus="status">
					<tbody>
						<tr class="text-c">
							...
							<td>${paperAnswerQuestionStudentAreaVo.score}</td>
						</tr>
					</tbody>
				</c:forEach>
			</table>
		...
		<%-- <div style="width: 100%; margin-left: 10px">
			...
			<div style="margin-left: 92%; margin-top: -20px">
				<a href="${webpath}/paperAnswer/toPaperAnswer2?pagenum=1">首页</a>
				...
				<c:forEach items="${infos.navigatepageNums}" var="pagenumber">
					<a
						href="${webpath}/paperAnswer/toPaperAnswer2?pagenum=${pagenumber}">${pagenumber}</a>
				</c:forEach>
				...
				<a
					href="${webpath}/paperAnswer/toPaperAnswer2?pagenum=${infos.pages}">末页</a>
			</div>
		</div> --%>
	</div>
